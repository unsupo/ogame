...
CREATE TABLE IF NOT EXISTS WEBDRIVER(
  ...
  ACTIVE      CHAR(1)  DEFAULT 'N' CHECK(USER_TYPE in ('A'/*ACTIVE*/, 'N' /*Not Active*/)),
...
CREATE TABLE IF NOT EXISTS EMAIL(
  ...
  PASSWORD    VARCHAR(100) DEFAULT EMAIL NOT NULL
);

INSERT INTO EMAIL(EMAIL, PASSWORD) VALUES ("None Given","None Given");

CREATE TABLE IF NOT EXISTS OGAME_USER(
  EMAIL_ID    INT REFERENCES EMAIL(ID) DEFAULT 1,
  ID          SERIAL PRIMARY KEY,
  EMAIL       VARCHAR(100) UNIQUE,
  PASSWORD    VARCHAR(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS BOT(
  ...
  ID              SERIAL PRIMARY KEY,
  name            VARCHAR(100) UNIQUE,
  ACTIVE          INT  DEFAULT 'N' CHECK(USER_TYPE in ('A'/*ACTIVE*/, 'N' /*Not Active*/)),
  start_date      TIMESTAMP DEFAULT current_timestamp
);
