...
CREATE TABLE IF NOT EXISTS PROFILE(
  ...
  BUILD_TIMESTAMP   TIMESTAMP   /*THE TIMESTAMP TO START BUILDING THIS BUILDABLE IF NULL OR PAST TIME THEN BUILD IT IF YOU CAN*/
);
...
CREATE TABLE IF NOT EXISTS PLANET_QUEUE(
  ...
  BUILD_TIMESTAMP   TIMESTAMP,   /*THE TIMESTAMP TO START BUILDING THIS BUILDABLE IF NULL OR PAST TIME THEN BUILD IT IF YOU CAN*/
  DONE          	  CHAR(1)  DEFAULT 'N' CHECK(DONE in ('Y'/*Yes*/, 'N' /*No*/)),
  PRIMARY KEY (BOT_PLANETS_ID,BUILDABLE_ID)
);
